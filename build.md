...
※ このとき(特に基板裏面)、ニッパが <span style="color: red;">マイコン上の部品に触れて壊すことのないよう</span>、十分気をつけて下さい。BOOTボタンはとくに脆いと思いますので注意して下さい。
...
あとは前と同様に、基板の裏面から、ピンヘッダのプラスティックの部品を外し、この面もはんだ付けし、余ったピンの頭をカットします。
